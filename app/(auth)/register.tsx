...
export default function RegisterScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      <TextInput style={styles.input} placeholder="Usuario (sin espacios)" value={username} onChangeText={setUsername} autoCapitalize="none" />
      ...
      <TouchableOpacity style={styles.button} onPress={() => register({ email, password, username })} disabled={isLoading}>
